...
// screens/WelcomeScreen.tsx (STATIC VERSION - Removes Reanimated to fix iOS crash)
...
// ⚠️ IMPORTANT: Removed all react-native-reanimated imports.
...
type WelcomeScreenProps = { 
  // Assuming the Welcome screen is registered at the 'Welcome' route now:
  navigation: NativeStackNavigationProp<RootStackParamList, "Welcome">; 
};

export default function WelcomeScreen({ navigation }: WelcomeScreenProps) {
  
  // Note: All animation logic (useSharedValue, useEffect, useAnimatedStyle) is removed.
...
const styles = StyleSheet.create({
  ...
  // --- STATIC WRAPPERS (Replaced Animated.View with View) ---
  leafIconWrapper: {
    position: 'absolute',
    top: -30,
    left: '25%',
